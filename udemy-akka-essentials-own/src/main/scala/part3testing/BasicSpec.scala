    ...
    with BeforeAndAfterAll
{
    ...
    "A simple actor" should {
        "send back the same message" in {
            ...
            expectMsg(message) // akka.test.single-expect-default for configure the timeout (actually 3 seconds)
            testActor
        }
    }
...
// Recommended companion object to include all values of the test
object BasicSpec {
